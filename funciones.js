function consultarBicicletas() {
    $.ajax(
             {
                url          : 'https://g6ec4e9341359c0-db202110141903.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike',
                type         : 'GET',
                dataType     : 'json',
...
function consultarClientes() {
    $.ajax(
             {
                url          : 'https://g6ec4e9341359c0-db202110141903.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/CLIENT/CLIENT',
                type         : 'GET',
                dataType     : 'json',
                success      :  function(json){
    ...
    $.ajax (
                {
                    ...
                    url          :'https://g6ec4e9341359c0-db202110141903.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/CLIENT/CLIENT' + codigo ,
                    type         : 'GET',
                    dataType     : 'json',
...
function consultarMensajes() {
    $.ajax(
             {
                url          : 'https://g6ec4e9341359c0-db202110141903.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/MESSAGE/MESSAGE',
                type         : 'GET',
                dataType     : 'json',
                success      :  function(json){
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g6ec4e9341359c0-db202110141903.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/MESSAGE/MESSAGE' + codigo ,
                       type         : 'GET',
                    dataType     : 'json',
